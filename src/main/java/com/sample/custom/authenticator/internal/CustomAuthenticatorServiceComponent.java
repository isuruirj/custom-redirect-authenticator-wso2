...
package com.sample.custom.authenticator.internal;

import com.sample.custom.authenticator.CustomAuthenticator;
...
/**
 * @scr.component name="com.sample.custom.authenticator.component" immediate="true"
...
public class CustomAuthenticatorServiceComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        try {
            CustomAuthenticator basicAuth = new CustomAuthenticator();
            ...
            log.error("CustomAuthenticator bundle activation Failed", e);
        }
    }
