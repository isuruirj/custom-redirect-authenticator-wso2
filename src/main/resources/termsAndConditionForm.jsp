            ...
            <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-4 col-centered wr-content wr-login col-centered">
                <div>
                    <h2 class="wr-title blue-bg padding-double white boarder-bottom-blue margin-none">
                        Accept Terms and Conditions for <%=request.getParameter("sp")%> Application &nbsp;&nbsp;</h2>
                </div>
                                    ...
                                    <div class="span6">
                                        ...
                                        <div class='col-md-12 form-group'>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                                                <input id="tcParam" name="tcParam" type="hidden" class="form-control" tabindex="0"
                                                       placeholder="input" autocomplete="off" value="tcParam">
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                                                <input id="tcInput" name="tcInput" type="checkbox" >
                                                <label for="tcInput"> I accept above terms and conditions</label><br>
                                            </div>
                                            <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group'>
